                ...
                <div class="container position-relative card">
                    ...
                    <div class="">
                        <div className='row d-flex justify-content-center'>
                            <div class="d-flex flex-column justify-content-center align-items-start h-100 p-sm-5">
                                <div class="d-flex align-items-center p-3">
                                    ...
                                    <div class="px-2">
                                        <h6 class="mb-0 contact-titles">Phone</h6>
                                        <p class="mb-0 contact-info">(832)736-5856</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center p-3">
                                    ...
                                    <div class="px-2">
                                        <h6 class="mb-0 contact-titles">Email</h6>
                                        <p class="mb-0 contact-info"><a href="mailto:fidel.webdev@gmail.com">fidel.webdev@gmail.com</a></p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center p-3">
                                    ...
                                    <div class="px-2">
                                        <h6 class="mb-0 contact-titles">Location</h6>
                                        <p class="mb-0 contact-info">Houston, Texas</p>
                                    </div>
                                </div>
                            </div>
                            <div className=''>
